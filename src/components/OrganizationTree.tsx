...
const initialNodes: Node[] = [
  {
    id: '1',
    data: { label: 'Группа Сбербанк', percentage: '100.00%' },
    position: { x: 400, y: 50 },
    type: 'custom',
  },
  {
    id: '2',
    data: { label: 'Afin Bank (OOO)', percentage: '(50.00%)' },
    position: { x: 50, y: 200 },
    type: 'custom',
  },
  {
    id: '3',
    data: { label: 'Газпром Сервис ОАО', percentage: '(47.95%)' },
    position: { x: 220, y: 200 },
    type: 'custom',
  },
  {
    id: '4',
    data: { label: 'НБКИ ОАО', percentage: '(5.03%)' },
    position: { x: 390, y: 200 },
    type: 'custom',
  },
  {
    id: '5',
    data: { label: 'Сбербанксервис ООО', percentage: '(98.48%)' },
    position: { x: 530, y: 200 },
    type: 'custom',
  },
  {
    id: '6',
    data: { label: 'СТАРТС (АО)', percentage: '(49.99%)' },
    position: { x: 680, y: 200 },
    type: 'custom',
  },
  {
    id: '7',
    data: { label: 'Внедрение Бизнесов ООО', percentage: '(99.93%)' },
    position: { x: 820, y: 200 },
    type: 'custom',
  },
  {
    id: '8',
    data: { label: 'Внедрения Строительных ООО', percentage: '(33.33%)' },
    position: { x: 980, y: 200 },
    type: 'custom',
  },
  {
    id: '9',
    data: { label: 'НВ-Дивелопмент Холдинг ООО', percentage: '(49.00%)' },
    position: { x: 1160, y: 200 },
    type: 'custom',
  },
  {
    id: '10',
    data: { label: 'SB Learning Infratech ООО', percentage: '(24.90%)' },
